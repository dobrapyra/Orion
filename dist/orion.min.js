...
/*! Orion - constellation */
var OrionConstellation=function(t){this.init(t)};Object.assign(OrionConstellation.prototype,{init:function(t){var e=t.points||{},i=t.force||{},s=t.amplitude||{},r=t.speed||{},n=t.opacity||{};this.onlyInside=t.onlyInside||!1,this.edgeTestPoints=t.edgeTestPoints||7,this.borderVertices=Object.assign([],e.border),this.prepareVertices(this.borderVertices,{force:i.border||60},{static:!0,border:!0}),this.insideVertices=Object.assign([],e.inside),this.prepareVertices(this.insideVertices,{ampMin:s.min,ampMax:s.max,speedMin:r.min,speedMax:r.max,force:i.border||40}),this.cursorPoint={curr:{x:0,y:0},cursor:!0,hidden:!!this.onlyInside,force:i.cursor||120},this.vertices=[].concat(this.borderVertices,this.insideVertices),this.vertices.push(this.cursorPoint),this.createEdges(),this.cursorPoint.static=!0,this.borderStrokeStyle="rgba(255,255,255,"+(void 0!==n.border?n.border:.5)+")"},prepareVertices:function(t,e,i){for(var s=!(!i||!i.static),r=void 0!==e.ampMin?e.ampMin:10,n=e.ampMax?e.ampMax-r:0,o=e.speedMin||.001,a=e.speedMax?e.speedMax-o:0,h=e.force||50,c=0,d=t.length;c<d;c++){var l=t[c];l.last={x:l.x,y:l.y},l.curr={x:l.x,y:l.y},s||(l.amp={x:Math.random()*n+r,y:Math.random()*n+r},l.angle={x:2*Math.random()*Math.PI,y:2*Math.random()*Math.PI},l.speed={x:Math.random()*a+o,y:Math.random()*a+o}),l.force=h,Object.assign(l,i)}},createEdges:function(){this.edges=[],this.cursorEdges=[];var t,e,i=this.vertices.length;for(t=0;t<i;t++){var s=this.vertices[t];for(e=t+1;e<i;e++){var r=this.vertices[e];if(!s.border||!r.border){var n=s.static&&r.static,o=s.force+r.force,a={v1:s,v2:r,lastA:0,currA:n?1-Math.min(Math.sqrt(Math.pow(r.curr.x-s.curr.x,2)+Math.pow(r.curr.y-s.curr.y,2))/o,1):0,force:o,static:n};this.edges.push(a),(s.cursor||r.cursor)&&this.cursorEdges.push(a)}}}},setOutsideDetector:function(t){var e=this.borderVertices[0];t.beginPath(),t.moveTo(e.x,e.y);for(var i=0,s=this.borderVertices.length;i<s;i++){var r=this.borderVertices[i];t.lineTo(r.x,r.y)}t.closePath()},setCursor:function(t,e,i){this.cursorPoint.curr={x:t,y:e},this.onlyInside&&i&&(this.cursorPoint.hidden=!i.isPointInPath(t,e),this.checkCursorEdge(i))},checkCursorEdge:function(t){for(var e=this.edgeTestPoints+1,i=0,s=this.cursorEdges.length;i<s;i++)for(var r=this.cursorEdges[i],n=r.v1.curr,o=r.v2.curr,a=(o.x-n.x)/e,h=(o.y-n.y)/e,c=1;c<e&&!(r.hidden=!t.isPointInPath(n.x+c*a,n.y+c*h));c++);},update:function(t,e){for(var i=0,s=this.vertices.length;i<s;i++){var r=this.vertices[i];r.static||(r.last={x:r.curr.x,y:r.curr.y},r.angle.x+=t*r.speed.x,r.angle.y+=t*r.speed.y,r.curr={x:r.x+r.amp.x*Math.sin(r.angle.x),y:r.y+r.amp.y*Math.cos(r.angle.y)})}this.checkCursorEdge(e);for(i=0,s=this.edges.length;i<s;i++){var n=this.edges[i];if(!n.hidden&&!n.static){var o=n.v1,a=n.v2;n.lastA=n.currA,n.currA=1-Math.min(Math.sqrt(Math.pow(a.curr.x-o.curr.x,2)+Math.pow(a.curr.y-o.curr.y,2))/n.force,1)}}},render:function(t,e){e.lineCap="round",e.lineWidth=1,e.strokeStyle=this.borderStrokeStyle;var i=this.borderVertices[0];e.beginPath(),e.moveTo(i.x,i.y);for(var s=0,r=this.borderVertices.length;s<r;s++){var n=this.borderVertices[s];e.lineTo(n.x,n.y)}e.closePath(),e.stroke();for(s=0,r=this.edges.length;s<r;s++){var o=this.edges[s];if(!(o.hidden||o.currA<=0)){var a,h,c,d,l=o.v1,u=o.v2;if(!l.hidden&&!u.hidden)o.static?e.strokeStyle="rgba(255,255,255,"+o.currA+")":e.strokeStyle="rgba(255,255,255,"+(o.lastA+(o.currA-o.lastA)*t)+")",l.static?(a=l.curr.x,h=l.curr.y):(a=l.last.x+(l.curr.x-l.last.x)*t,h=l.last.y+(l.curr.y-l.last.y)*t),u.static?(c=u.curr.x,d=u.curr.y):(c=u.last.x+(u.curr.x-u.last.x)*t,d=u.last.y+(u.curr.y-u.last.y)*t),e.beginPath(),e.moveTo(a,h),e.lineTo(c,d),e.stroke()}}e.strokeStyle="rgb(255,255,255)",e.lineWidth=3;for(s=0,r=this.vertices.length;s<r;s++){var f,p;(n=this.vertices[s]).hidden||(n.static?(f=n.curr.x,p=n.curr.y):(f=n.last.x+(n.curr.x-n.last.x)*t,p=n.last.y+(n.curr.y-n.last.y)*t),e.beginPath(),e.moveTo(f,p),e.lineTo(f+.2,p+.2),e.stroke())}}});
/*! Orion - core */
var Orion=function(t){this.init(t)};Object.assign(Orion.prototype,{init:function(t){this.viewport=t.viewport,this.canvas=this.createCanvas(),this.ctx=this.canvas.getContext("2d"),this.eventHandler=t.eventHandler||t.viewport,this.fpsMeter=t.fpsMeter,this.density=t.density||1,this.w=(t.w||1280)*this.density,this.h=(t.h||720)*this.density,this.canvas.width=this.w,this.canvas.height=this.h,this.refresh(),this.loop=new Loop({fpsLimit:t.fpsLimit||36,handleUpdate:this.update.bind(this),handleRender:this.render.bind(this),fpsMeter:!!this.fpsMeter}),this.constellation=new OrionConstellation(this.prepareConstellation(t.constellation)),t.constellation.onlyInside&&(this.offScreenCanvas=this.createOffscreenCanvas(),this.offscreenCtx=this.offScreenCanvas.getContext("2d"),this.constellation.setOutsideDetector(this.offscreenCtx)),this.bindEvents(),this.loop.start()},createCanvas:function(){var t=document.createElement("canvas");return Object.assign(t.style,{position:"relative",width:"100%",height:"auto"}),this.viewport.appendChild(t),t},createOffscreenCanvas:function(){return document.createElement("canvas")},prepareConstellation:function(t){var e=t.points||{};return Object.assign(t,{points:{border:this.recalcPoints(e.border),inside:this.recalcPoints(e.inside)}})},recalcPoints:function(t){var e=this.density;return 1!==e?t.map(function(t){return{x:t.x*e,y:t.y*e}}):t},refresh:function(){this.offset=this.viewport.getBoundingClientRect();var t=this.offset.width/this.viewport.offsetWidth;this.scale=Math.round(this.canvas.offsetWidth/this.canvas.width*t*1e5)/1e5},bindEvents:function(){this.eventHandler.addEventListener("mousemove",this.onMouseMove.bind(this)),window.addEventListener("resize",this.onWinResize.bind(this))},onMouseMove:function(t){var e=(t.pageX-this.offset.x)/this.scale,i=(t.pageY-this.offset.y)/this.scale;this.constellation.setCursor(e,i,this.offscreenCtx)},onWinResize:function(t){clearTimeout(this.resizeTimeout),this.resizeTimeout=setTimeout(this.onResizeTimeout.bind(this),200)},onResizeTimeout:function(){this.refresh()},update:function(t){this.constellation.update(t,this.offscreenCtx)},render:function(t,e){this.ctx.clearRect(0,0,this.w,this.h),this.constellation.render(t,this.ctx),this.fpsMeter&&(this.fpsMeter.innerText=Math.round(e)+" FPS")}});